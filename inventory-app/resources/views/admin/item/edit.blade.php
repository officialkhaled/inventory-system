...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.inventory.item.update', ['inventory' => $inventory->id, 'item' => $item->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div>
                            ...
                            <input type="number" class="form-control" placeholder="Quantity" name="quantity" value="{{ $item->quantity ?? '' }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="profile-image-container">
                            <img id="showImage" class="profile-image avatar-lg" src="{{ asset($item->img_path ?? 'assets/images/no_image.png') }}" alt="">
                        </div>
                    </div>
                </div>
